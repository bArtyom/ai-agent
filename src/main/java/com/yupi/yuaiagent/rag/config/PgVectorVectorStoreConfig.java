...
public class PgVectorVectorStoreConfig {
    ...
    @Bean
    public VectorStore pgVectorVectorStore(@Qualifier("pgVectorJdbcTemplate")JdbcTemplate jdbcTemplate, @Qualifier("ollamaEmbeddingModel") EmbeddingModel embeddingModel) {
